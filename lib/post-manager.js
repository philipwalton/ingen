...
var filter = require('lodash-node/modern').filter;
...
PostManager.prototype.enumerable = function() {
  return filter(this.posts, function(post) {
    return post.enumerable !== false;
  });
};
