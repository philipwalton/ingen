...
// Posts should appear in templates and queries unless
// their draft property is `true` and the environment is `production`
Post.prototype.isPrivate = function() {
  return this.draft && this.env == 'production'
}
