...
Post.prototype._getLayouts = function() {
  ...
  var layout = File.getOrCreateFromFile(this.config.layoutsDirectory + '/' + this.layout + '.html')
  this.layouts = [layout]
  while (layout.data && layout.data.layout) {
    layout = File.getOrCreateFromFile(this.config.layoutsDirectory + '/' + layout.data.layout + '.html')
