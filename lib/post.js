...
Post.prototype.init = function(obj, type, config) {
  ...
  if (obj instanceof Template) {
    ...
    var data = _.omit(obj, 'content');
    this.template = new Template(data, content, config);
  }
...
Post.prototype.clone = function() {
  var clone = Object.create(Post.prototype);
...
Post.prototype._linkProperties = function() {
