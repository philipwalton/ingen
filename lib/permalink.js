...
// "Class" methods
Permalink.getFromPage = function(page) {

  // if the page already has a permalink, return it
  if (page.permalink instanceof Permalink) return page.permalink

  var permalink = page.permalink
    ? page.permalink
    : require('./site').config.permalink
  ...
  return new Permalink(permalink, data)
}
