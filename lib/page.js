...
Page.prototype.getTemplateData = function() {
  if (this._templateData) return this._templateData;

  this._templateData = _.assign({}, this.template.data, {
      site: this.config
    }, {
...
Page.prototype.render = function() {
  ...
  if (this.post && this.post.content) {
    ...
    this.content = this.template.renderContent(this.getTemplateData());
    events.emit('afterRenderContent', this)
  }

  // Render the layout.
  events.emit('beforeRenderLayout', this)
  this.content = this.template.renderLayout(
    this.content,
...
Page.prototype._resolvePermalink = function() {
  ...
  var permalinkStructure = data.permalink || this.config.permalink

  this.permalink = new Permalink(permalinkStructure, data);
}
