...
Page.prototype.render = function() {
  this.content = renderTemplateDeep(this.file, {
    site: site.config,
    page: this.file.data,
...
function renderTemplateDeep(file, data) {
  // render this file's content before recursing
...
function getDestinationPath(file) {
  var dest = file.data && file.data.url
    ? file.data.url
    : file.name
